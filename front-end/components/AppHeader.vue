...
<template>
    <header>
        ...
        <div class="left-bar">
            ...
            <div class="theme" @click="switchDocumentTheme">
                <div class="icon">
                    <n-icon v-if="theme == 'light'" size="26"> <SunIcon /> </n-icon>
                    <n-icon v-if="theme == 'dark'" size="26"> <MoonIcon /> </n-icon>
                </div>
            </div>
            <div class="app">
    ...
    <n-modal
v-model:show="showLogoutModal" preset="dialog" :closable="false" type="warning"
